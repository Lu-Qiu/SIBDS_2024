...
# Your answer starts here
data(airports)
flights2 %>% left_join(airports, by = join_by("origin" == "faa"))
flights2 %>% left_join(airports, by = join_by("dest" == "faa"))

left_join(flights2, airports, by = join_by("origin" == "faa"))
right_join(flights2, airports, by = join_by("origin" == "faa"))
```
